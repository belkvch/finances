                            ...
                            <form method="POST" action="/operations" class="mb-0">
                                ...
                                <div class="mb-3">
                                    <label class="d-flex">Operation amount:
                                        <input type="number" min="0.01" step=".01" name="salary"
                                    ...
                                    <label class="form-label d-flex">Operation category:
                                        <select class="form-select" name="category_id">
                                            <c:forEach items="${categories}" var="categories">
                                                <option value="${categories.getId()}"><c:out
                                                        value="${categories.getName()}"/></option>
                                            </c:forEach>
                                        </select>
                                    </label>
                                </div>
                                <div class="modal-footer justify-content-center">
                                    ...
                                    <button type="submit" class="btn btn-outline-primary" style="width: 120px;">Add
                                    </button>
                                </div>
                            </form>
                        </div>
