...
public class DefaultSubscriptionDAO implements SubscriptionDAO {
    ...
    private static final String SELECT_ALL_FOR_ACCOUNT = "select * from subscriptions where account_id=? ORDER BY id";
    private static final String INSERT_SUBSCRIPTION = "insert into subscriptions(name,is_active,account_id)  VALUES(?,?,?)";
